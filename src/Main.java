...
public class Main {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            System.out.println("send Get http method to get the temp value from the api");
            ...
            System.out.println("Run Test to vaidate the temp value from the api and the temp value from the weather.com");
            ApiTemp.getTempFromWeather();


            // open the metric url and run all the tests
